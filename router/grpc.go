...
func SetupGRPCRoutes(server *grpc.Server, db *sql.DB, idClient identity.Client, authDisabled bool) {
	...
	meetService := meets.NewService(meetsRepo, idClient, templateService)
